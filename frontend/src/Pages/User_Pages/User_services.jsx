...
const User_services = () => {
    ...
    <div id="why-choose">
        ...
        <ul>
            <li>Reliable, user-driven data and AI analysis for accurate street information.</li>
            <li>Real-time updates to avoid disruptions during your walks.</li>
            <li>Community-centered platform, improving the walking experience for everyone.</li>
        </ul>
    </div>

    <div id="get-involved">
        <h2>Ready to Walk with Ease?</h2>
        <p>Explore the city with Wakez. Whether you need a scenic route, a quick path, or an accessible street, our services have you covered. Download the Wakez app today and start exploring.</p>
    </div>
